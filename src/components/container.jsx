...
import { CROSSWORD_DATA } from '../constant';
...
const calculateGridLayout = () => {
    ...
    const pivotCol = Math.max(...CROSSWORD_DATA.map(d => d.keyIndex));
    ...
    const totalRows = CROSSWORD_DATA.length;
    ...
    CROSSWORD_DATA.forEach((item, rowIndex) => {
...
export default function KeywordCrossword() {
  // State
  ...
  useEffect(() => {
    const firstRowItem = CROSSWORD_DATA[0];
  ...
  const activeQuestion = useMemo(() => {
      return CROSSWORD_DATA[activeCell.row]?.question || "";
  }, [activeCell.row]);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-xs text-slate-400 mt-0.5">
                <span className="bg-slate-800 px-1.5 py-0.5 rounded text-amber-400 font-mono font-bold tracking-wider">FOTOBER</span>
              </div>
            </div>
          </div>
                                ...
                                {cellData && (
                                    <>
                                        ...
                                        {cIndex === (pivotCol - CROSSWORD_DATA[rIndex].keyIndex) && (
                                            <div className="absolute  -left-5 sm:-left-6 md:-left-8 top-0 -translate-y-1/2 w-5 sm:w-6 text-right ">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-in fade-in zoom-in duration-300">
              <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full text-center relative overflow-hidden">
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-4 mb-6">
                       ...
                       <span className="block text-3xl font-black text-amber-500 tracking-[0.2em]">FOTOBER</span>
                  </div>
